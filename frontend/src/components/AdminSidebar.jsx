...
import { Users, FileText, Flag, Mail, LayoutDashboard } from "lucide-react";
...
const AdminSidebar = () => {
  ...
  return (
    <div className="w-72 min-h-screen bg-base-100 shadow-xl border-r border-gray-300 dark:border-gray-700 p-6">
            ...
            className={({ isActive }) =>
              `flex items-center gap-4 px-5 py-3 rounded-lg text-[17px] font-medium tracking-wide transition-all ${
                isActive
                  ...
                  : "text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800 hover:text-primary"
              }`
            }
          >
